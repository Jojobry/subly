...
- **storage** — to save your subscriptions and settings on your device.
- **alarms** — to schedule a once-a-day local check for upcoming renewals.
- **notifications** — to show you an on-device reminder before a subscription renews or a free trial ends. These notifications are generated locally; nothing is sent to us or anyone else.
...
Questions about privacy? Open an issue at **https://github.com/Jojobry/subly/issues**.
